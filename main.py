        ...
        if file and allowed_file(file.filename):
            ...
            if face_rect is not None:
                ...
                if face_embedding is not None:
                    sql = "INSERT INTO users (username, password, email, role, image_path, face_encoding) VALUES (%s, %s, %s, %s, %s, %s)"
                    values = (username, hashed_password, email, role, image_path, json.dumps(face_embedding.tolist()))
